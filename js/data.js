...
const PRODUCTS = [
  { name:'iPhone 6S', brand:'Apple', category:'iPhone', tagline:'A dependable classic iPhone, still capable of everyday tasks.',
    description:'The iPhone 6S remains a reliable, pocketable option for calls, messaging and light browsing. Fully data-wiped and tested on our 60-point checklist.',
    price:2399, was:2899, condition:'Fair', battery:78, storage:['16GB','32GB','64GB'], colors:['Gold','Silver'],
    stock:8, rating:4.3, reviews:22,
    specs:[['Display','4.7" Retina HD'],['Chip','A9'],['Camera','12MP main'],['Battery health','78% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 6S Plus', brand:'Apple', category:'iPhone', tagline:'The larger-screen classic, tested and ready for daily use.',
    description:'A bigger display and longer battery life than the standard 6S, in a well-worn but fully functional certified unit.',
    price:3199, was:3699, condition:'Fair', battery:79, storage:['16GB','32GB','64GB'], colors:['Silver','Space Grey'],
    stock:6, rating:4.3, reviews:15,
    specs:[['Display','5.5" Retina HD'],['Chip','A9'],['Camera','12MP main'],['Battery health','79% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 7', brand:'Apple', category:'iPhone', tagline:'A simple, sturdy iPhone that still gets the job done.',
    description:'Water-resistant and dependable, the iPhone 7 is a solid low-cost option for anyone who just needs a phone that works.',
    price:2299, was:2799, condition:'Good', battery:81, storage:['32GB','128GB','256GB'], colors:['Black','Silver'],
    stock:10, rating:4.4, reviews:31,
    specs:[['Display','4.7" Retina HD'],['Chip','A10 Fusion'],['Camera','12MP main'],['Battery health','81% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 7 Plus', brand:'Apple', category:'iPhone', tagline:'Dual cameras and solid everyday performance at a low entry price.',
    description:'The first iPhone with dual rear cameras, still a capable performer for everyday use at a genuinely low price.',
    price:2999, was:3499, condition:'Good', battery:82, storage:['32GB','128GB','256GB'], colors:['Rose Gold','Black'],
    stock:7, rating:4.4, reviews:19,
    specs:[['Display','5.5" Retina HD'],['Chip','A10 Fusion'],['Camera','Dual 12MP'],['Battery health','82% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 8', brand:'Apple', category:'iPhone', tagline:'The last of the classic home-button design, fully tested.',
    description:'Wireless charging and a faster chip round out the classic iPhone design. Certified, cleaned and ready to go.',
    price:2999, was:3499, condition:'Good', battery:84, storage:['64GB','128GB','256GB'], colors:['Gold','Space Grey'],
    stock:12, rating:4.5, reviews:27,
    specs:[['Display','4.7" Retina HD'],['Chip','A11 Bionic'],['Camera','12MP main'],['Battery health','84% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 8 Plus', brand:'Apple', category:'iPhone', tagline:'A bigger classic-design iPhone with dual rear cameras.',
    description:'Dual cameras and a larger display, with wireless charging built in. A dependable, well-tested certified unit.',
    price:4099, was:4799, condition:'Good', battery:83, storage:['64GB','256GB'], colors:['Gold','Silver'],
    stock:9, rating:4.4, reviews:18,
    specs:[['Display','5.5" Retina HD'],['Chip','A11 Bionic'],['Camera','Dual 12MP'],['Battery health','83% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone X', brand:'Apple', category:'iPhone', tagline:'The iPhone that introduced Face ID and an edge-to-edge display.',
    description:'A genuine design milestone — OLED display, Face ID and no home button. Tested and certified with fresh diagnostics.',
    price:5099, was:5999, condition:'Good', battery:82, storage:['64GB','256GB'], colors:['Silver','Space Grey'],
    stock:6, rating:4.5, reviews:24,
    specs:[['Display','5.8" Super Retina OLED'],['Chip','A11 Bionic'],['Camera','Dual 12MP'],['Battery health','82% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone XR', brand:'Apple', category:'iPhone', tagline:'A colourful, capable iPhone that remains excellent value.',
    description:"Face ID and a big, bright LCD display in Apple's most popular colourway lineup. Great everyday value, fully certified.",
    price:4799, was:5599, condition:'Excellent', battery:87, storage:['64GB','128GB','256GB'], colors:['Blue','White'],
    stock:14, rating:4.6, reviews:45,
    specs:[['Display','6.1" Liquid Retina LCD'],['Chip','A12 Bionic'],['Camera','12MP main'],['Battery health','87% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone XS', brand:'Apple', category:'iPhone', tagline:'A compact iPhone with dual cameras and solid everyday speed.',
    description:'OLED display and dual cameras in a compact frame. Tested end to end and backed by our 30-day warranty.',
    price:5299, was:6199, condition:'Good', battery:85, storage:['64GB','256GB'], colors:['Gold','Silver'],
    stock:8, rating:4.5, reviews:21,
    specs:[['Display','5.8" Super Retina OLED'],['Chip','A12 Bionic'],['Camera','Dual 12MP'],['Battery health','85% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone XS Max', brand:'Apple', category:'iPhone', tagline:'The larger-screen XS, certified and ready for daily use.',
    description:'The biggest display Apple offered in 2018, paired with dual cameras and solid everyday performance.',
    price:6299, was:7299, condition:'Excellent', battery:86, storage:['64GB','256GB'], colors:['Silver','Space Grey'],
    stock:7, rating:4.6, reviews:20,
    specs:[['Display','6.5" Super Retina OLED'],['Chip','A12 Bionic'],['Camera','Dual 12MP'],['Battery health','86% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 11', brand:'Apple', category:'iPhone', tagline:'Dual cameras and all-day battery life at an accessible price.',
    description:'One of the most popular iPhones ever made — dual cameras, strong battery life, and a genuinely low certified price.',
    price:5999, was:6999, condition:'Excellent', battery:89, storage:['64GB','128GB','256GB'], colors:['Black','White'],
    stock:16, rating:4.7, reviews:58,
    specs:[['Display','6.1" Liquid Retina LCD'],['Chip','A13 Bionic'],['Camera','Dual 12MP'],['Battery health','89% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 11 Pro', brand:'Apple', category:'iPhone', tagline:'A pocketable Pro with triple rear cameras.',
    description:"Apple's first triple-camera system, in a compact OLED body. Fully certified with fresh battery diagnostics.",
    price:7499, was:8699, condition:'Excellent', battery:88, storage:['64GB','256GB'], colors:['Midnight Green','Silver'],
    stock:9, rating:4.6, reviews:30,
    specs:[['Display','5.8" Super Retina XDR OLED'],['Chip','A13 Bionic'],['Camera','Triple 12MP'],['Battery health','88% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 11 Pro Max', brand:'Apple', category:'iPhone', tagline:'Pro-level cameras on the biggest screen of its generation.',
    description:'The largest, longest-lasting iPhone 11, with the same triple-camera system as the 11 Pro. Certified and warrantied.',
    price:8999, was:10499, condition:'Excellent', battery:87, storage:['64GB','256GB'], colors:['Gold','Space Grey'],
    stock:6, rating:4.7, reviews:25,
    specs:[['Display','6.5" Super Retina XDR OLED'],['Chip','A13 Bionic'],['Camera','Triple 12MP'],['Battery health','87% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone SE (2020)', brand:'Apple', category:'iPhone', tagline:'Compact, fast, and built around a familiar design.',
    description:'The A13 Bionic chip in a compact, affordable body. A dependable choice for anyone who prefers a smaller phone.',
    price:3799, was:4499, condition:'Good', battery:85, storage:['64GB','128GB'], colors:['Black','White'],
    stock:11, rating:4.5, reviews:29,
    specs:[['Display','4.7" Retina HD'],['Chip','A13 Bionic'],['Camera','12MP main'],['Battery health','85% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 12', brand:'Apple', category:'iPhone', tagline:"5G speed in Apple's refined flat-edge design.",
    description:'The design that defined the modern iPhone look, with 5G and Ceramic Shield durability. Fully certified.',
    price:7099, was:8299, condition:'Excellent', battery:90, storage:['64GB','128GB','256GB'], colors:['Blue','White'],
    stock:13, rating:4.7, reviews:41,
    specs:[['Display','6.1" Super Retina XDR OLED'],['Chip','A14 Bionic'],['Camera','Dual 12MP'],['Battery health','90% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 12 Mini', brand:'Apple', category:'iPhone', tagline:'Full flagship performance in a genuinely compact body.',
    description:'All the speed and camera quality of the iPhone 12, shrunk into Apple\u2019s smallest recent design.',
    price:6499, was:7599, condition:'Excellent', battery:89, storage:['64GB','128GB','256GB'], colors:['Purple','Blue'],
    stock:8, rating:4.6, reviews:22,
    specs:[['Display','5.4" Super Retina XDR OLED'],['Chip','A14 Bionic'],['Camera','Dual 12MP'],['Battery health','89% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 12 Pro', brand:'Apple', category:'iPhone', tagline:'Pro cameras and Ceramic Shield durability, certified and tested.',
    description:'A triple-camera Pro system with LiDAR scanning, in Apple\u2019s toughened Ceramic Shield glass. Fully diagnosed and certified.',
    price:9799, was:11499, condition:'Excellent', battery:90, storage:['128GB','256GB'], colors:['Pacific Blue','Silver'],
    stock:7, rating:4.7, reviews:26,
    specs:[['Display','6.1" Super Retina XDR OLED'],['Chip','A14 Bionic'],['Camera','Triple 12MP + LiDAR'],['Battery health','90% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 12 Pro Max', brand:'Apple', category:'iPhone', tagline:'The largest-screen 12, with the full Pro camera system.',
    description:'The biggest display and longest battery life of the 12 line-up, with the complete triple-camera Pro system.',
    price:10799, was:12699, condition:'Excellent', battery:89, storage:['128GB','256GB'], colors:['Graphite','Gold'],
    stock:5, rating:4.7, reviews:23,
    specs:[['Display','6.7" Super Retina XDR OLED'],['Chip','A14 Bionic'],['Camera','Triple 12MP + LiDAR'],['Battery health','89% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone SE (2022)', brand:'Apple', category:'iPhone', tagline:'A compact iPhone with 5G and modern performance.',
    description:'The A15 Bionic chip and 5G in Apple\u2019s compact, familiar form factor. A great value pick, fully certified.',
    price:6199, was:7299, condition:'Excellent', battery:92, storage:['64GB','128GB'], colors:['Midnight','Red'],
    stock:15, rating:4.6, reviews:33,
    specs:[['Display','4.7" Retina HD'],['Chip','A15 Bionic'],['Camera','12MP main'],['Battery health','92% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 13', brand:'Apple', category:'iPhone', tagline:'A faster chip and longer battery life in a familiar, loved design.',
    description:'One of the most reliable iPhones ever made, with a smaller notch and noticeably longer battery life than the 12.',
    price:9799, was:11499, condition:'Excellent', battery:91, storage:['128GB','256GB'], colors:['Pink','Blue'],
    stock:14, rating:4.8, reviews:47, featured:true,
    specs:[['Display','6.1" Super Retina XDR OLED'],['Chip','A15 Bionic'],['Camera','Dual 12MP'],['Battery health','91% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 13 Mini', brand:'Apple', category:'iPhone', tagline:"Full iPhone 13 performance in Apple's smallest recent frame.",
    description:'The same A15 chip and dual-camera system as the 13, in a genuinely pocketable size for those who want it small.',
    price:8399, was:9799, condition:'Excellent', battery:90, storage:['128GB','256GB'], colors:['Starlight','Midnight'],
    stock:7, rating:4.6, reviews:18,
    specs:[['Display','5.4" Super Retina XDR OLED'],['Chip','A15 Bionic'],['Camera','Dual 12MP'],['Battery health','90% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 13 Pro', brand:'Apple', category:'iPhone', tagline:'ProMotion smoothness and a serious triple-camera system.',
    description:'A 120Hz ProMotion display and a genuinely capable triple-camera system. One of our most thoroughly certified units.',
    price:12799, was:14999, condition:'Pristine', battery:93, storage:['128GB','256GB'], colors:['Sierra Blue','Graphite'],
    stock:9, rating:4.8, reviews:24, featured:true,
    specs:[['Display','6.1" Super Retina XDR ProMotion OLED'],['Chip','A15 Bionic'],['Camera','Triple 12MP'],['Battery health','93% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 13 Pro Max', brand:'Apple', category:'iPhone', tagline:'The biggest screen, battery and camera system of the 13 line-up.',
    description:'ProMotion, the longest battery life Apple had shipped at the time, and the full triple-camera Pro system.',
    price:14899, was:17499, condition:'Excellent', battery:91, storage:['128GB','256GB'], colors:['Alpine Green','Silver'],
    stock:6, rating:4.8, reviews:21,
    specs:[['Display','6.7" Super Retina XDR ProMotion OLED'],['Chip','A15 Bionic'],['Camera','Triple 12MP'],['Battery health','91% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 14', brand:'Apple', category:'iPhone', tagline:'A refined, dependable iPhone ready for daily life.',
    ...
    price:11699, was:13699, condition:'Excellent', battery:92, storage:['128GB','256GB'], colors:['Midnight','Blue'],
    stock:12, rating:4.7, reviews:35,
    specs:[['Display','6.1" Super Retina XDR OLED'],['Chip','A15 Bionic'],['Camera','Dual 12MP'],['Battery health','92% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 14 Pro', brand:'Apple', category:'iPhone', tagline:'Dynamic Island and Pro-grade cameras, certified and tested.',
    description:'The Pro camera system and Dynamic Island, in great condition and backed by our 30-day warranty.',
    price:13199, was:15499, condition:'Pristine', battery:94, storage:['128GB','256GB'], colors:['Deep Purple','Space Black'],
    stock:8, rating:4.8, reviews:28,
    specs:[['Display','6.1" Super Retina XDR ProMotion OLED, Dynamic Island'],['Chip','A16 Bionic'],['Camera','Triple 48MP'],['Battery health','94% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 14 Pro Max', brand:'Apple', category:'iPhone', tagline:'The most capable 14, with the largest display and battery.',
    description:"Dynamic Island, the 48MP Pro camera system, and Apple's longest 14-series battery life, fully certified.",
    price:15599, was:18299, condition:'Excellent', battery:93, storage:['128GB','256GB'], colors:['Gold','Silver'],
    stock:6, rating:4.8, reviews:19,
    specs:[['Display','6.7" Super Retina XDR ProMotion OLED, Dynamic Island'],['Chip','A16 Bionic'],['Camera','Triple 48MP'],['Battery health','93% of original capacity']],
    included:['USB-C to Lightning cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 15', brand:'Apple', category:'iPhone', tagline:'Dynamic Island and a 48MP camera, now with USB-C.',
    description:'Dynamic Island, a 48MP main camera and USB-C, in a colour-infused glass and aluminium design. Fully certified.',
    price:15599, was:18299, condition:'Excellent', battery:95, storage:['128GB','256GB'], colors:['Pink','Black'],
    stock:11, rating:4.8, reviews:29,
    specs:[['Display','6.1" Super Retina XDR OLED, Dynamic Island'],['Chip','A16 Bionic'],['Camera','48MP main + 12MP ultra-wide'],['Battery health','95% of original capacity']],
    included:['USB-C cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 15 Pro', brand:'Apple', category:'iPhone', tagline:'A titanium design with A17 Pro speed and serious camera power.',
    description:'A serious camera system in a refined titanium frame. Tested and certified with full battery diagnostics before it ever reaches you.',
    price:20599, was:24199, condition:'Excellent', battery:96, storage:['128GB','256GB'], colors:['Natural Titanium','White Titanium'],
    stock:7, rating:4.9, reviews:22,
    specs:[['Display','6.1" Super Retina XDR ProMotion OLED'],['Chip','A17 Pro'],['Camera','48MP main + 12MP ultra-wide + 12MP telephoto'],['Battery health','96% of original capacity']],
    included:['USB-C cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 15 Pro Max', brand:'Apple', category:'iPhone', tagline:'Our top-tier certified iPhone — titanium build and the longest zoom in the line-up.',
    ...
    price:23999, was:27999, condition:'Pristine', battery:96, storage:['256GB'], colors:['Natural Titanium','Blue Titanium','Black Titanium'],
    stock:6, rating:4.9, reviews:34, featured:true,
    specs:[['Display','6.7" Super Retina XDR ProMotion OLED'],['Chip','A17 Pro'],['Camera','48MP main + 12MP ultra-wide + 12MP telephoto'],['Battery health','96% of original capacity']],
    included:['USB-C cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 16', brand:'Apple', category:'iPhone', tagline:"The newest generation, with Apple's latest chip and camera system.",
    description:"Apple's latest-generation iPhone, freshly certified with our full inspection ahead of listing.",
    price:21499, was:24999, condition:'Pristine', battery:98, storage:['256GB'], colors:['Ultramarine','Teal'],
    stock:9, rating:4.9, reviews:14, newArrival:true,
    specs:[['Display','6.1" Super Retina XDR OLED'],['Chip','A18'],['Camera','48MP main + 12MP ultra-wide'],['Battery health','98% of original capacity']],
    included:['USB-C cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 16 Pro', brand:'Apple', category:'iPhone', tagline:'Refined titanium design with even faster Pro performance.',
    description:'A larger display, the A18 Pro chip, and the full titanium Pro camera system. Newly certified stock.',
    price:27599, was:31999, condition:'Pristine', battery:97, storage:['256GB'], colors:['Desert Titanium','Natural Titanium'],
    stock:5, rating:4.9, reviews:11, newArrival:true,
    specs:[['Display','6.3" Super Retina XDR ProMotion OLED'],['Chip','A18 Pro'],['Camera','Triple 48MP'],['Battery health','97% of original capacity']],
    included:['USB-C cable','SIM eject tool','iConnect certified box & documentation'] },
  { name:'iPhone 16 Pro Max', brand:'Apple', category:'iPhone', tagline:'The largest, most capable iPhone we sell, fully certified.',
    description:"The newest and largest Pro Max, with the full titanium camera system and Apple's longest battery life to date.",
    price:29999, was:34999, condition:'Pristine', battery:98, storage:['256GB'], colors:['Desert Titanium','Black Titanium'],
    stock:4, rating:5.0, reviews:8, newArrival:true,
    specs:[['Display','6.9" Super Retina XDR ProMotion OLED'],['Chip','A18 Pro'],['Camera','Triple 48MP'],['Battery health','98% of original capacity']],
    included:['USB-C cable','SIM eject tool','iConnect certified box & documentation'] },
